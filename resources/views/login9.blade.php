...
<main id="main">
    ...
    <form x-data="{
        ...
        }).setErrors({{ \Illuminate\Support\Js::from($errors->messages()) }}),
        submit(e) {
            e.preventDefault();
            this.form.validate({
                only: ['username', 'password'],
                onSuccess: (response) => e.target.submit()
            })
        }
    }" @submit="submit" class="p-4 pb-10  flex flex-col gap-8 mx-auto max-w-xl">
        ...
        <div class="flex flex-col gap-2">
            ...
            <input
                ...
                :aria-invalid="form.invalid('username')"
                aria-describedby="username-error"
                :class="{'border-red-500': form.invalid('username')}"
            >
            <span id="username-error" class="text-red-500" role="alert" x-text="form.errors.username"></span>
        ...
        <div class="flex flex-col gap-2">
            ...
            >
            <span id="password-error" class="text-red-500" role="alert" x-text="form.errors.password"></span>
        </div>
