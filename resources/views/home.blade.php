...
<html lang="it">
    ...
    <body>
        ...
        <div>
            ...
            <p class="text-4xl font-semibold text-center p-4 text-gray-400">XPUG Trento Merch Store</p>
            ...
            <div class="p-4 pb-10  flex flex-col gap-8">
                ...
                <div class="grid lg:grid-cols-4 gap-8">
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="text-2xl font-semibold">Maglietta Uomo</p>
                    </div>

                    <div class="flex flex-col gap-2">
                        <img src="/storage/woman-tshirt.png" class="aspect-square object-cover">
                        <p class="text-2xl font-semibold">Maglietta Donna</p>
                    </div>

                    <div class="flex flex-col gap-2">
                        <img src="/storage/mug.png" class="aspect-square object-cover">
                        <p class="text-2xl font-semibold">Tazza con Logo</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-100 p-4 flex flex-col gap-4">
                ...
                <a href="#" class="hover:underline text-2xl font-semibold">Quanto è semplice il "Simple Design"?</a>
                <a href="#" class="hover:underline text-2xl font-semibold">Javascript: in the loop</a>
                <a href="#" class="hover:underline text-2xl font-semibold">XPUG Trento - Coding Dojo</a>
            </div>
