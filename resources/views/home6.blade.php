...
<header class="bg-green-200 p-4 relative">
    <nav aria-labelledby="primary-navigation" x-data="{subMenuVisible: false}">
        ...
        <ul class="flex items-center gap-8 text-xl text-green-950 font-semibold">
            ...
            <li>
                <a href="/prodotti" class="hover:underline" x-on:click.prevent="subMenuVisible = true">Prodotti</a>
                <div x-show="subMenuVisible" id="subnav" x-on:click.outside="subMenuVisible = false" class="absolute top-full left-0 w-full bg-cyan-200 text-cyan-900">
